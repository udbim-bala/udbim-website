...
const RecruitPricing = () => {
  ...
  const whatsappLinks = {
    requestCandidates: `https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent(
      "Hello, I'm interested in hiring candidates. Can you assist me?"
    )}`,
    getStarted: `https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent(
      "Hi, I'm looking for a career opportunity as a candidate. Can you guide me?"
    )}`,
    hireTalent: `https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent(
      "Hello, I want to hire talent for my company."
    )}`,
    getHired: `https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent(
      "Hi, I'm looking for a job opportunity. Can you help me to get started."
    )}`,
  };
    ...
    <section className="pricing-section" id="pricing">
      <div className="pricing-container">
        <div className="section-header">
          ...
          <p>
            Flexible options tailored for both employers and job seekers in the
            Detailing & BIM industry
          </p>
        </div>
