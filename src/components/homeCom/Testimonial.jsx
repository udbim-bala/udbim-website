...
const Testimonial = () => {
  ...
  return (
    <section className="testimonial-container">
      <div className="whatsapp-banner-container">
        <div className="whatsapp-banner">
          <div className="whatsapp-content">
            ...
            onClick={() => {
              const message = encodeURIComponent("Hi! I'm interested in learning more about your training programs.");
              window.open(`https://wa.me/918122149339?text=${message}`, '_blank');
            }}>
              <svg 
                stroke="currentColor" 
                fill="currentColor" 
